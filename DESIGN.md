...
| **Date** | 2026-06-25 |
| **Status** | Implemented / Current (v0.2.3 alpha — PRs 1–11 complete; theme picker; center-bounce gauge waveform) |
...
|--------|------------|-------|
| **Boost (home)** | Arc slider (100–200%) with opt-in center-bounce waveform inset in gauge, system volume row, session status strip | Haptic detents at 125/150/175/200%; fixed-position bounce bars above the fold (issue #9 C position; issue #16) |
