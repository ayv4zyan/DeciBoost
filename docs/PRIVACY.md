...
In v0.2.1 (alpha), **About → Privacy policy** opens this document on GitHub (`main` branch). A hosted or in-app policy page may replace this link before the `1.0.0` stable release.
